...
preferred = ['no_finding', 'infiltration', 'atelectasis', 'effusion', 'nodule', 'pneumothorax', 'mass', 'consolidation', 'cardiomegaly']
for label in labels:
    if(label[2] in preferred):
        ...
        for img in train:
            ...
            target = '/home/jf/Documents/estudio/xrays/split_in_folders/299_small/train/' + label[2] + '/'
            base = base + img
            target = target + img
            print(base, target)
        ...
        for img in val:
            base = '/home/jf/Documents/estudio/xrays/split_in_folders/299/' + label[2] + '/'
            target = '/home/jf/Documents/estudio/xrays/split_in_folders/299_small/val/' + label[2] + '/'
            base = base + img
            target = target + img
            print(base, target)
            copyfile(base, target)
        ...
        for img in test:
            base = '/home/jf/Documents/estudio/xrays/split_in_folders/299/' + label[2] + '/'
            target = '/home/jf/Documents/estudio/xrays/split_in_folders/299_small/test/' + label[2] + '/'
            base = base + img
            target = target + img
            print(base, target)
            copyfile(base, target)
