...
for type_folder in type_folders:
    ...
    for img in train:
        ...
        target = '/home/jf/Documents/estudio/xrays/split_in_folders/299_small_aug_less_values/train/' + label + '/'
        base = base + img
        target = target + img
        print(base, target)
    ...
    for img in val:
        base = '/home/jf/Documents/estudio/xrays/split_in_folders/some_augmented_299/' + label + '/'
        target = '/home/jf/Documents/estudio/xrays/split_in_folders/299_small_aug_less_values/val/' + label + '/'
        base = base + img
        target = target + img
        print(base, target)
        copyfile(base, target)
    ...
    for img in test:
        base = '/home/jf/Documents/estudio/xrays/split_in_folders/some_augmented_299/' + label + '/'
        target = '/home/jf/Documents/estudio/xrays/split_in_folders/299_small_aug_less_values/test/' + label + '/'
        base = base + img
        target = target + img
        print(base, target)
        copyfile(base, target)
