...
for label in labels:
    if(label[2] in preferred):
        label[0]=label[0][:3955]
        label[1]=label[1][:3955]
        ...
        for img in train:
            ...
            target = '/home/jf/Documents/estudio/xrays/split_in_folders/224SBL/train/' + label[2] + '/'
            base = base + img
            target = target + img
        ...
        for img in val:
            base = '/home/jf/Documents/estudio/xrays/split_in_folders/224/' + label[2] + '/'
            target = '/home/jf/Documents/estudio/xrays/split_in_folders/224SBL/val/' + label[2] + '/'
            base = base + img
            target = target + img
            print(base[49:], target[49:])
            copyfile(base, target)
        ...
        for img in test:
            base = '/home/jf/Documents/estudio/xrays/split_in_folders/224/' + label[2] + '/'
            target = '/home/jf/Documents/estudio/xrays/split_in_folders/224SBL/test/' + label[2] + '/'
            base = base + img
            target = target + img
            print(base[49:], target[49:])
            copyfile(base, target)
